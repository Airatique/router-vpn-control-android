...
Android-приложение для управления VPN-профилями на домашних роутерах через SSH. Это порт [Windows-версии Router VPN Control](https://github.com/Airatique/router-vpn-control): та же логика работы с роутером, те же управляющие скрипты, но в виде мобильного приложения.
